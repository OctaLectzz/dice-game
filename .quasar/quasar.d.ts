...
interface ImportMetaEnv {
  ...
  readonly ANTIGRAVITY_AGENT?: number;
  readonly ANTIGRAVITY_CSRF_TOKEN?: string;
  readonly ANTIGRAVITY_EDITOR_APP_ROOT?: string;
  readonly ANTIGRAVITY_LS_ADDRESS?: string;
  readonly ANTIGRAVITY_SOURCE_METADATA?: string;
  readonly ANTIGRAVITY_TRAJECTORY_ID?: string;
  ...
  readonly EFC_17456_1592913036?: number;
  ...
  readonly npm_config_allow_scripts?: string;
  ...
  readonly npm_config_package?: string;
  readonly npm_config_prefix?: string;
